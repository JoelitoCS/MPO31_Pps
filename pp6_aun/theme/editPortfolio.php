...
<div class="form-container">
    <form method="POST">
        ...
        <input type="text" name="titol" value="<?= $portf['titol'] ?>" required><br><br>

        <label>Descripción:</label><br>
        <input type="text" name="descripcio" value="<?= $portf['descripcio'] ?>"><br><br>

        <label>Imagen:</label><br>
        <textarea name="imatge" value="<?= $portf['imatge'] ?>" required></textarea><br><br>

        <label>Categoria:</label><br>
        <input type="text" name="categoria" value="<?= $portf['categoria'] ?>"><br><br>
