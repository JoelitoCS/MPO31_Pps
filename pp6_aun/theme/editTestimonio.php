...
$testimonios = $result->fetch_assoc();
...
<div class="form-container">
    <form method="POST">
        ...
        <input type="text" name="nom" value="<?= $testimonios['nom'] ?>" required><br><br>

        <label>Apellido:</label><br>
        <input type="text" name="cognom" value="<?= $testimonios['cognom'] ?> "><br><br>

        <label>Testimonio:</label><br>
        <textarea name="testimoni" value="<?= $testimonios['testimoni'] ?> " required></textarea><br><br>

        <label>Imagen:</label><br>
        <input type="text" name="imatge" value="<?= $testimonios['imatge'] ?> "><br><br>
